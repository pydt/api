...
describe('test docker image', () => {
  ...
  test.each(files)(
    ...
    async file => {
      ...
      expect(fs.readFileSync(`_testdata/expected/${file}/header.yaml`)).toStrictEqual(
        fs.readFileSync(`_testdata/out/${file}/header.yaml`)
      );
      expect(fs.readFileSync(`_testdata/expected/${file}/map.tsv`)).toStrictEqual(
        fs.readFileSync(`_testdata/out/${file}/map.tsv`)
      );
    },
    10000
  );
