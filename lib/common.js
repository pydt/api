...
function CivxError(message, logError) {
    this.name = 'CivxError';
...
CivxError.prototype = Object.create(Error.prototype);
CivxError.prototype.constructor = CivxError;
...
module.exports = {
  ...
  lp: {
    ...
    error: (event, cb, error, message) => {
      ...
      if (error instanceof CivxError && !error.logError) {
